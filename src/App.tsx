...
function App(): JSX.Element {
  ...
  const baseUrl = process.env.NODE_ENV === "production" ? "https://paste-bin-yara-burvin.herokuapp.com/" : "http://localhost:4000"
  ...
  return (<>
  {allPastes.map((el) => <SinglePaste element = {el} key = {el.id}/>)}
  </>);
}
